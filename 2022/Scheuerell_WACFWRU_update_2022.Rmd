...
par(mfrow = c(1,2), mai = c(1, 1, 0.75, 0))
plot.ts(x1, las = 1, col = "gray", lwd = 3, ylim = range(x1, y1),
        ylab = expression(italic(x[t])), main = "")
mtext("Positive bias", side = 3, line = 1, cex = 2)
lines(y1, col = "dodgerblue", lwd = 2)

plot.ts(x2, las = 1, col = "gray", lwd = 3, ylim = range(x2, y2),
        ylab = expression(italic(x[t])), main = "")
mtext("Negative bias", side = 3, line = 1, cex = 2)
...
# Model changes in fish mass via a _state-space_ model
...
### https://github.com/mdscheuerell/wacfwru-mtg/2002
